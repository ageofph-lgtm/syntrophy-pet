...
export default function PetCard({ pet, onEdit, onSelect, selected }) {
  ...
  return (
    <div
      ...
      className={`
        relative bg-white border rounded-2xl p-4 transition-all duration-200 shadow-sm
        ${onSelect ? "cursor-pointer" : ""}
        ${selected ? "border-orange-400 ring-2 ring-orange-100" : "border-stone-200 hover:border-stone-300 hover:shadow-md"}
      `}
    >
      {hasVaccineWarning && (
